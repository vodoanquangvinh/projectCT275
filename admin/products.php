...
if(isset($_GET['delete'])){
   ...
   header('location: ../public/index_admin.php?act=products');
}
...
<section class="show-products">
   ...
   <div class="box">
      ...
      <div class="price"><span><?= number_format($fetch_products['price']); ?></span> VNĐ</div>
      <div class="details"><span><?= $fetch_products['details']; ?></span></div>
      <div class="flex-btn">
         <a href="../admin/update_product.php?update=<?= $fetch_products['id']; ?>" class="option-btn">cập nhật</a>
         <a href="../admin/products.php?delete=<?= $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('Bạn có chắc chắn xóa sẳn phẩm hay không?');">xóa</a>
      </div>
   </div>
   <?php
         }
